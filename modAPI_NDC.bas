...
Private Sub Test_NDC_API()
    Call API_NDC_PullData("tenofovir", 2, True, ThisWorkbook.Sheets(3))
End Sub
...
Public Sub API_NDC_PullData(ByVal strSearch As String, _
    ...
    While lngSkip < intTotal Or intTotal = 0
        ...
        Select Case True
            ...
            Case Else
                ...
                intTotal = vJSON("meta")("results")("total")
                ' Output extracted data to sheet
                OutputByNDC outputSheet, vJSON, numNDC
                ' Update progress bar
                pctProgress = lngSkip / intTotal
                With formProgress
                    .lblCaption = "Pulling data: " & lngSkip & " of " & intTotal & _
                        " (" & Int(pctProgress * 100) & "%)"
        ...
        lngSkip = lngSkip + 100
        ' Close progress bar
        If lngSkip >= intTotal Then Unload formProgress
    Wend
